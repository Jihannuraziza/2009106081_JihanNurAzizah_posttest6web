<?php
    ...
    if(isset($_POST['create'])){
        ...
        $query = mysqli_query($connect, "INSERT INTO stok (id_laptop, tanggal_masuk, jumlah, total) VALUES ('$idMenu','$tanggal_masuk','$jumlah','$total')");

        $queryTambah = mysqli_query($connect, "UPDATE laptop SET stok = stok + '$jumlah' WHERE id_laptop='$idMenu'");
